...
set CLASSPATH=%APP_HOME%\lib\jcoinche-client.jar;%APP_HOME%\lib\common.jar;%APP_HOME%\lib\netty-all-4.1.6.Final.jar

@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" com.charlestati.jcoinche.Client %CMD_LINE_ARGS%
