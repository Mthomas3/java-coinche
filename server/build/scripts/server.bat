...
set CLASSPATH=%APP_HOME%\lib\jcoinche-server.jar;%APP_HOME%\lib\common.jar;%APP_HOME%\lib\netty-all-4.1.6.Final.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" com.charlestati.jcoinche.Server %CMD_LINE_ARGS%
